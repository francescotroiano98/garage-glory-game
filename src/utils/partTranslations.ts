...
export const CATEGORY_DISPLAY_NAMES: Record<Language, Record<VehicleCategory, string>> = {
  ...
  it: {
    ...
    truck_delivery: 'Corriere', truck_flatbed: 'Pianale', truck_box: 'Furgone Box',
    truck_tow: 'Carro Attrezzi', truck_semi_light: 'Semirimorchio Leggero', truck_semi: 'Semirimorchio',
