      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="relative p-4 py-5 border-b border-border bg-card/95 backdrop-blur-sm shrink-0 sticky top-0 z-20">
          <div className="flex items-start gap-3">
            <Button variant="ghost" size="icon" onClick={onBack} className="shrink-0" data-tutorial-id="tutorial-repair-back" aria-label="Back to garage">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2" data-tutorial-id="tutorial-repair-area">
